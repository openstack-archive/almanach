...
class TestServerUpdate(base.BaseAlmanachTest):
    ...
    def test_instance_update(self):
        ...
        update_field = oslo_serialization.jsonutils.dumps({'start_date': '2016-04-14T18:30:00.00Z',
                                                           'flavor': 'NewFlavor'})
        resp, response_body = self.almanach_client_().update_server(server['id'], update_field)

        updated_server = oslo_serialization.jsonutils.loads(response_body)
