...
class TestMixedAuthentication(base.BaseTestCase):
    ...
    def tearDown(self):
        ...
        self.auth_one.validate.side_effect = None
        self.auth_two.validate.side_effect = None
        self.auth_one.validate.return_value = None
        self.auth_two.validate.return_value = None
