...
function start_ceilometer {
    run_process ceilometer-collector "$ALMANACH_BIN_DIR/almanach collector $ALMANACH_CONF"
    run_process ceilometer-api "$ALMANACH_BIN_DIR/almanach api $ALMANACH_CONF --host 0.0.0.0"
}
